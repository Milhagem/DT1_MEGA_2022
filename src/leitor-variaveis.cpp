...
void loop() {
    ...
    if( ( (digitalRead(botao1_pedal)== HIGH) && (digitalRead(botao2_pedal)== LOW) ) || (digitalRead(acelerador) == LOW) ){
        ...
        Serial.println("Carro ON ");
          ...
          Serial.println("Carro OFF");
    }

    hallA_estado = digitalRead(hallA);    //variavel recebe o valor do sensor Hall A
    hallB_estado = digitalRead(hallB);    //variavel recebe o valor do sensor Hall B
    hallC_estado = digitalRead(hallC);    //variavel recebe o valor do sensor Hall C
  ...
  case 4:
    ...
    Serial.println("Hall A: ");
    Serial.print(hallA_estado);
    Serial.print("\tHall B: ");
    Serial.print(hallB_estado);
    Serial.print("\tHall C: ");
    Serial.print(hallC_estado);
    Serial.print("\tHall val: ");
    Serial.print(hall_val);
    
    Serial.println("acelerador: ");
    Serial.print(acelerador);
    
    Serial.println("Inic R: ");
    Serial.print(inicio_rampa);
    Serial.print("\tEstd C: ");
    Serial.print(chave_controle);

    Serial.println("Bt1_pd: ");
    Serial.print(digitalRead(botao1_pedal));
    Serial.print("\tBt2_pd: ");
    Serial.print(digitalRead(botao2_pedal));
